...
| Document | For | Covers |
|---|---|---|
| [OVERVIEW.md](OVERVIEW.md) | any developer, first | the design in five minutes: the pipeline, a frame's journey, what happens on a goal, vocabulary |
| [USER_GUIDE.md](USER_GUIDE.md) | the person with the panel | first run, the web pages, every board, alerts, off-season behaviour, troubleshooting |
| [HARDWARE.md](HARDWARE.md) | installing on a Pi | parts, the installer, updates, security model, display settings, the service |
| [DEVELOPMENT.md](DEVELOPMENT.md) | contributors | setup from scratch, workflow, golden tests, deploying to the bench Pi, fonts and logos |
